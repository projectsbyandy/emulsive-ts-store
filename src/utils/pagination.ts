...
type ConstructBeforeOrNextParams = {
  currentPage: number;
  pageCount: number;
  search: string;
  pathname: string;
...
export const constructUrlForPrevOrNext = ({currentPage, pageCount, search, pathname} : ConstructBeforeOrNextParams) : {prevUrl: string, nextUrl: string} =>  {
